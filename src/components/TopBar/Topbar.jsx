...
function Topbar() {
  ...
  const PF = "https://blog-backend-7rds.onrender.com/Images/"
  ...
  const toggleCatList = async () => {
    if (!catExpanded) {
      try {
        const res = await axios.get("https://blog-backend-7rds.onrender.com/blog/category");
  ...
  const handleLogout = async (e) => {
    setUser(null);
    await axios.post("https://blog-backend-7rds.onrender.com/blog/auth/logout");
    navigate("/login");
  };
